...
//        $this->middleware('sentinel.auth', ['except' => [
    ...
    public function store(Request $request)
    {
        ...
        // // $product['thumbnail'] =  $manager->make()->resize(800, 800, function ($constraint)   {
        // //     $constraint->aspectRatio();
        // // })->save($dest, $name);
        // // \Image::make(asset($dest, $name))->resize(800, 8000)->save();
        // //
        // $manager->resize(200, 200, function ($constraint) {
        //     $constraint->aspectRatio();

        // });

        // $product['thumbnail'] = "/". $manager;
        ...
        $img = \Image::make($thumbnail)->resize(200, 200)->save();
