<?php
phpartisanmake:migration:schemacreate_tasks_table--schema = 'name:string';
phpartisancrud:genaddress--fields = 'nickname:string:nullable,address_type:string:nullable,address:string:nullable,street:string:nullable,street_additional:string:nullable,city:string:nullable,state:string:nullable,country:string:nullable,postal:string:nullable,latitude:string:nullable,longitude:string:nullable,user_id:integer:unsigned'phpartisancrud:genprofile--fields = 'uuid:uuid,username:string,display_name:string,gender:enum,dob:date,dob_month:string,dob_day:string,dob_year:text,bio:text,phone_type:enum,phone:string,address_id:string,user_api_key:string,user_api_secret:string,user_activation_key:string,slug:string,activation_code_id:string,activation_code:string,confirmation_code:string,position:string,company:string,website:string,skypeid:string,supervisor:string,employment_status:enum,employment_title:string,employment_role:string,published:boolean,activated:boolean,remember:boolean,confirmed:boolean,is_employee:boolean,is_fake:boolean,published_on:timestamp,activated_on:timestamp,pic:string';
phpartisanmake:migration:schemacreate_addresses_table--schema = 'nickname:string:nullable,address_type:string:nullable,address:string:nullable,street:string:nullable,street_additional:string:nullable,city:string:nullable,state:string:nullable,country:string:nullable,postal:string:nullable,latitude:string:nullable,longitude:string:nullable,user_id:integer:foreign';
phpartisanphillips:create - crudProfile--fieldsFile = '/database/inputfields/profile.json'--skipMigration;
$flight = newFlight;
$flight->name = $request->name;
$flight->save();
Youhavetopassoption--fieldsFile = absolute_file_path_or_path_from_base_directorywithcommand . e . g . phpartisanphillips:create - crudProfile--fieldsFile = '/database/inputfields/profile.json'--skipMigration;
phpartisanphillips:create - crudProfile--fieldsFile = "fields.json
