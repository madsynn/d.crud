    ...
    public function run()
    {
        ...
        \DB::table('articles')->insert(array (
            ...
            array (
                ...
                'subtitle' => NULL,
                'excerpt' => 'Today quilting is as much a hobby for enjoyment as it is a professional endeavor. Whether for fun or profit, quilting is a great opportunity to create. Nothing has made these projects easier than the quilting sewing machine. ',
                'content' => '<p>Quilting started as a social activity. Farm wives got together when they weren&#39;t performing chores. They made bed coverings, curtains, petticoats and other articles. Patchwork was a result of a fabric shortage. Old items would be woven into a single fabric, producing wondrous designs. That form has become everything from an expression of art to a charitable statement.</p>
...
',
                'slug' => 'enhance-your-quilt-with-sewing-quilting-machines',
                'meta_title' => 'Enhance Your Quilt with Sewing Quilting Machines',
                'fb_title' => NULL,
                'gp_title' => NULL,
                'tw_title' => NULL,
                ...
                'file_name' => 'enahance_your_quilt.jpg',
                'file_size' => 57773,
                'category_id' => 1,
                'user_id' => 0,
                ...
                'updated_at' => '2016-08-18 19:50:56',
                'deleted_at' => NULL,
            ),
            1 => 
            array (
                ...
                'subtitle' => NULL,
                'excerpt' => 'One of the best quilting sewing machines for sale for home use is the long arm quilt frame machine. They allow you to make quilts of all sizes. The long arm permits you to move the sewing head freely without moving the fabric, which allows for the precision detail.',
                'content' => '<p>Quilters tend to be very passionate about their talent and rightfully so! However, finding the right sewing machine is essential for every level of quilting. Therefore, it&rsquo;s important to look at the features of quilting sewing machines for sale that are best for you.</p>
...
',
                ...
                'path' => '/uploads/article/',
                'file_name' => 'which_quilting_machine-min.jpg',
                'file_size' => 15989,
                'category_id' => 1,
                'user_id' => 0,
                'link_to_product_title' => 'add seo product link title here',
                ...
                'lang' => 'en',
                'created_at' => '2016-05-10 13:02:37',
                'updated_at' => '2016-08-18 18:32:57',
                'deleted_at' => NULL,
            ),
            2 => 
            array (
...
',
                ...
                'gp_title' => NULL,
                'tw_title' => NULL,
                'meta_keywords' => 'hand quilting frames',
                'meta_description' => 'hand quilting frames',
                'path' => '/uploads/article/',
                'file_name' => 'hand_quilt_frames.jpg',
                'file_size' => 70951,
                'category_id' => 1,
                'user_id' => 0,
                'link_to_product_title' => 'add seo product link title here',
                ...
                'lang' => 'en',
                'created_at' => '2016-05-10 13:02:37',
                'updated_at' => '2016-08-18 18:33:23',
                'deleted_at' => NULL,
            ),
            3 => 
            array (
            ...
            array (
                ...
                'subtitle' => NULL,
                'excerpt' => 'By asking the right questions when shopping for affordable long arm quilting machines, you know you will get the features that you need in the end. Keep this handy guide with you as you shop, and always ask about any sewing machine feature you are unsure about.',
                'content' => '<p>For many years quilters had to go through the painstaking process of sewing their creations using a traditional sewing machine. This involved working in a tight space, trying to maneuver a large piece, or stack, of fabric. There is no question that the long arm sewing machine makes the joy of quilting even more joyous. If you are looking for affordable long arm quilting machines, there are a few very important questions to ask to ensure you end up with the best model. </p> <strong>How much quilting space does the machine offer?</strong> <p>The quilting space and throat space are not equal. Make sure to ask about available quilting space. When you consider investing into one of the affordable long arm quilting machines, remember the bigger is not always the best. The most fitting quilting space is always a comfortable distance for both reach and sight. The recommended distance, for the most comfortable controlled quilting, is from a 12-inch to a 14-inch reach.</p> <strong>Does the machine run smoothly at both high and low speeds? How much does the machine weigh?</strong> <p>A machine that is too heavy will cause stress on neck, arms, and back. Test any machine for five minutes or longer to get a sense of what several hours of quilting might feel like. A comfortable weight is usually 65 pounds or less. An excess of vibration can bring about intemperate noise and poor line quality.</p> <strong>Where is the machine manufactured and is there a trusted warranty?</strong> <p>If it is important to you that your quilting machine is produced in the United States, then ask the question. A trusted warranty for electrical, mechanical and the outer casting issues you a guarantee of grade A craftsmanship when investing in a quilting machine. Trustworthy companies will stand behind their product and provide a written warranty. They will also provide you convenient customer support services.</p> <strong>Does the frame system require constant adjustment as you roll your quilt?</strong> <p>Making acclamations to your knitting surface, by either bringing down or raising your quilt edge to give a level surface on which to join, every time you move your blanket, it turns out to be extremely badly designed and amazingly prolonged. An optional 24-inch Super Leader replaces the 18-inch leader and eliminates the need to reach across the frame to attach the backing.</p> <p>By asking the right questions when shopping for affordable long arm quilting machines, you know you will get the features that you need in the end. Keep this handy guide with you as you shop, and always ask about any sewing machine feature you are unsure about.</p>',
            ...
            array (
                ...
                'subtitle' => NULL,
                'excerpt' => 'Some of the most interesting quilting frames being made today are the Grace Company Quilting Frames. Grace Company designs their frames to work with large quilting machines, making it easy to quickly manufacture quilts as efficiently as possible. Here is a closer look at the benefits that these frames offer quilt makers.',
                'content' => '<p>Some of the most interesting quilting frames being made today are the Grace Company Quilting Frames. Grace Company designs their frames to work with large quilting machines, making it easy to quickly manufacture quilts as efficiently as possible. Here is a closer look at the benefits that these frames offer quilt makers.</p> <h2>Designed for Machine Use</h2> <p>Grace Company Quilting Frames are designed to make the creation of new quilts with machines as easy as possible. They are designed to be used with a wide range of different quilting machine types, allowing manufacturers to select the perfect machine and frame combo to allow their quilts to be manufactured with the highest quality possible.</p> <p>One thing that is getting a lot of attention in the quilt-making world these days is the Qnique Quilter. This is one of the best quilt-making machines on the market, and many manufacturers are turning to the Qnique Quilter to improve their capacity to make quilts quickly and efficiently with the highest possible quality.</p> <p>Grace Company Quilting Frames are designed to be used with the Qnique Quilter. In fact, the Qnique Quilter machine was actually designed specifically to be used with the frames made by Grace Company. The software that Qnique uses includes the best automated quilting programs to make quilting with these frames a breeze.</p> <p>This makes it easy for quilt makers to set up a combination of frame and machine that works perfectly together. This will streamline their quilt making, saving them time, money and energy. Using frames from Grace Company in conjunction with the Qnique Quilter is a great move that will instantly improve a quilt makerï¿½s bottom line.</p> <h2>Long History of Excellence</h2> <p>Grace Company Quilting Frames are the oldest in the quilting world. They have the longest track record of making great quilting frames. The high quality materials they use to construct their quilting frames ensure that all of their products meet quiltersï¿½ standards. This keeps the quilt makers coming back, and that is why the frames made by Grace Company have the highest possible reputation in the industry.</p> <p>Anyone looking for the best frames possible should check out Grace Company Quilting Frames. Their quality construction and ease-of-use make them a great fit in any quilting environment. They are known as the leaders in the quilting industry because of the quality of the frames they make, and quilts made with these frames will reflect that quality.</p>',
                'slug' => 'grace-company-quilting-frames',
                'meta_title' => NULL,
                'fb_title' => NULL,
                'gp_title' => NULL,
                'tw_title' => NULL,
                'meta_keywords' => 'grace company quilting frames',
                'meta_description' => 'Some of the most interesting quilting frames being made today are the Grace Company Quilting Frames. Grace Company designs their frames to work with large quilting machines, making it easy to quickly manufacture quilts as efficiently as possible. Here is a closer look at the benefits that these frames offer quilt makers.',
                'path' => NULL,
                'file_name' => NULL,
                'file_size' => NULL,
                'category_id' => 1,
            ...
            array (
                ...
                'subtitle' => NULL,
                'excerpt' => 'For those quilters who want plenty of work space packed into a smaller machine, the Qnique Quilter does just that.  A mid arm quilting machine offers numerous advantages over traditional long arm machines.',
                'content' => '<p>Creating a quilt can be one of the most beautiful crafting activities, but it can also be one of the most tedious. When looking at quilts that were made entirely by hand generations ago, it&#39;s hard to imagine how much time and effort it took. Fortunately, technology has advanced to the point of creating equipment that makes doing even the biggest and most complex quilt easier than ever.  For many quilters, a mid-arm machine such as the Qnique Quilter works best for their projects.  Allowing for work on projects that earlier would have required a long-arm machine, these machines offer a variety of features that make sewing even the most complex quilt a pleasure.</p> <h2>Advantages of a Mid Arm Quilting Machine</h2> <p>For those quilters who want plenty of work space packed into a smaller machine, the Qnique Quilter does just that.  A mid arm quilting machine offers numerous advantages over traditional long arm machines, such as:</p> <ul> <li>Extended Work Area</li> <li>Multiple Accessory Ports</li> <li>Dual Thread Towers</li> <li>Built-in Stitch Regulation</li></ul> <p>In addition, a mid arm quilting machine is easier to control due to its quick-access buttons that allow for all functions of the machine to be controlled from its two handles, each of which contain three function buttons.</p> <h2>The Technology of Quilting</h2> <p>What make today&#39;s quilts so much easier to make are the advances in technology.  With computer automated software such as Quiltmotion available on these machines, the possibilities are endless when it comes to the patterns and styles that can be used on modern quilts.  Whether working on a standard block or one that&#39;s a little bigger, a mid arm quilting machine can do the job every time.</p> <h2>Mid Arms and Quilting Frames</h2> <p>For many quilters, one of their biggest problems is finding a machine that fits well with their quilting frame.  With a mid arm machine such as the Qnique Quilter, this is never an issue.  The Grace Company, which is considered the pioneer of quilting frames, offers two frames that work well with mid arm machines.  The SR-2 sets up in Queen or Crib size, while the recently-developed Qnique 14+ frame is a king-size version designed specifically for larger quilts.</p> <p>Making the best quilt takes the right combination of skill, style and patience along with the best equipment.  For beginners as well as experienced quilters, using a mid arm quilting machine such as the Qnique Quilter can help turn an ordinary quilt into a true masterpiece.</p>',
                'slug' => 'mid-arm-quilting-machine',
                'meta_title' => NULL,
                'fb_title' => NULL,
                'gp_title' => NULL,
                'tw_title' => NULL,
                'meta_keywords' => 'mid arm quilting machine',
                'meta_description' => 'For those quilters who want plenty of work space packed into a smaller machine, the Qnique Quilter does just that.  A mid arm quilting machine offers numerous advantages over traditional long arm machines',
                'path' => NULL,
                'file_name' => NULL,
                'file_size' => NULL,
                'category_id' => 1,
