...
class CreateEcommerceTables extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table)
        {
            ...
            $table->string('additional_heading')->default('Additional Information');
            $table->string('reviews_heading')->default('Product Reviews');

            $table->string('waranty_heading')->default('Product Waranty Info');
            $table->string('support_heading')->default('Product Support');
            $table->string('docs_heading')->default('Product Documentation');
            ...
            $table->boolean('reviews_tab')->default(0);
             $table->boolean('warranty_tab')->default(0);
             $table->boolean('docs_tab')->default(0);
             $table->boolean('support_tab')->default(0);
